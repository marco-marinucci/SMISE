...
$(function() {
  ...
  function set_settings() {
    ...
    // In condition 1, the participant will receive 3 like at the following timepoint (in ms). Default: [12000, 9999999]
    settings.condition_1_likes = [12000, 25000, 128000, 9999999]; 
    ...
    settings.condition_3_likes = [10000, 11000,15000,35000,80000,110000,150000,20000];  
